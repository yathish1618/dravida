...
export interface ApiItemFlashcardItemFlashcard
  extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::item-flashcard.item-flashcard'
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    updatedAt: Schema.Attribute.DateTime;
...
export interface ApiLevelItemLinkLevelItemLink
  extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    item_flashcard: Schema.Attribute.Relation<
      'manyToOne',
      'api::item-flashcard.item-flashcard'
    >;
...
export interface ApiLevelLevel extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    item_links: Schema.Attribute.Relation<
      'oneToMany',
      'api::level-item-link.level-item-link'
    >;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::item-flashcard.item-flashcard': ApiItemFlashcardItemFlashcard;
      'api::level-item-link.level-item-link': ApiLevelItemLinkLevelItemLink;
